...
/** Configures throttle parameter for a peer.
    ...
    measured round trip time happens to be significantly less than the mean
    round trip time measured over the interval, then the throttle probability is
    ...
    ENET_PEER_PACKET_THROTTLE_SCALE, on unreliable packets are dropped by ENet,
    ...
    taken into account to determine a sensible limit for the throttle
    probability above which it should not raise even in the best of conditions.
